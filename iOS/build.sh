...
cp ~/Library/Developer/Xcode/DerivedData/SkipTracer-gwcgrcitumrdjncbxhuwxnazwvkr/Build/Products/Debug-iphoneos/SkipTracer.framework/SkipTracer Payload/Spotify.app/Frameworks/libskip.dylib 
